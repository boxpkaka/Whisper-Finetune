...
add_arg("base_model", type=str, default=None, help="原模型路径")
...
# 获取Whisper的基本模型
base_model_path = args.base_model if args.base_model is not None else peft_config.base_model_name_or_path
